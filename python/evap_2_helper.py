...
while(np.abs(Ecool) - np.abs(Eevap)) >= 0: # and flag == 0:
    ...
    #Pc, Tc, L = param2.Pc[i]/0.001, param2.Tc[i]/0.001, param2.L[i] / 0.001 # \
        #param2.L[i] * 0.2 * np.random.rand() + param2.L[i] * 0.9
    ...
    Pctry, Tctry, Ltry = param2.Pc[i] * 0.02 * np.random.rand() + param2.Pc[i] * 0.99, \
                        param2.Tc[i] * 0.02 * np.random.rand() + param2.Tc[i] * 0.99, \
                        param2.L[i] * 0.2 * np.random.rand() + param2.L[i] * 0.9 
    #param2.L[i] / 1.0001 #\
    ...
    while (match.success) == False:
        Pctry, Tctry, Ltry = Pctry * 0.02 * np.random.rand() + Pctry * 0.95, \
                        Tctry * 0.02 * np.random.rand() + Tctry * 0.99, \
                        Ltry * 0.2 * np.random.rand() + Ltry * 0.9 
        #Pctry, Tctry, Ltry = Pctry / 1.0001, Tctry / 1.0001, Ltry * 0.2 * np.random.rand() + Ltry * 0.9
        x0 = (Pctry, Tctry, Ltry)  
        match = root(delta, x0)
        it += 1
            #if it == 100:
